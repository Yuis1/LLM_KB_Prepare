...
def convert_files(input_dir, report_path):
    ...
    for root, dirs, files in os.walk(input_dir):
        ...
        for file in files:
            ...
            try:
                # 构建输出路径
                output_filename = f"{file}.md"  # 修改: 在原始扩展名后添加 .md
                output_path = os.path.join(root, output_filename)  # 修改: 输出到原目录
...
if __name__ == "__main__":
    try:
        ...
        report_path = os.path.join(input_dir, "conversion_report.csv")  # 修改: 报告文件路径
